...
{
    /// <summary>
    ///This is a test class for IFileCounterTest and is intended
    ///to contain all IFileCounterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class IFileCounterTest
    {
        ...
        internal virtual IFileCounter CreateIFileCounter()
        {
            // TODO: Instantiate an appropriate concrete class.
            IFileCounter target = null;
            return target;
        }
        ...
        {
            IFileCounter target = CreateIFileCounter(); // TODO: Initialize to an appropriate value
